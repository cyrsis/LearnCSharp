...
namespace _09_04_03
{
    ...
    /// 沒有可用的中繼資料文件。
    /// </summary>
    public partial class XINEntities1 : ObjectContext
    {
        #region 建構函式
    
        /// <summary>
        /// 使用在應用程式組態檔的 'XINEntities1' 區段中找到的連接字串，初始化新的 XINEntities1 物件。
        /// </summary>
        public XINEntities1() : base("name=XINEntities1", "XINEntities1")
        {
        ...
        /// <summary>
        /// 初始化新的 XINEntities1 物件。
        /// </summary>
        public XINEntities1(string connectionString) : base(connectionString, "XINEntities1")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// 初始化新的 XINEntities1 物件。
        /// </summary>
        public XINEntities1(EntityConnection connection) : base(connection, "XINEntities1")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// 沒有可用的中繼資料文件。
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="XINModel1", Name="Product")]
    [Serializable()]
