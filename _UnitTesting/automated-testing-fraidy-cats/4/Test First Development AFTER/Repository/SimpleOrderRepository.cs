...
namespace Repository
{
  ...
  {
    private readonly SalesModelContext _context = new SalesModelContext();
    ...
    public List<CancelledOrder> CachedCancelledOrders()
    {
      return _context.CancelledOrders.Local.ToList();
    }
  }
}
