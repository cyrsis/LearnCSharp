...
namespace Models.Tests
{
    ...
    public class Circle_UnitTests
    {
        ...
        [TestMethod]
        public void Accept_ReceivesVisitor_PassesCorrectValuesToVisitCircle()
        {
        ...
        [TestMethod]
        public void Accept_ReceivesVisitor_InvokesVisitCircleOnce()
        {

            Mock<IShapeVisitor> visitorMock = new Mock<IShapeVisitor>();
            visitorMock
                .Setup(v => v.VisitCircle(It.IsAny<Location>(), It.IsAny<decimal>()))
                .Verifiable();
            IShapeVisitor visitor = visitorMock.Object;

            Circle circle = new Circle(new Location(), 1.0M);
            circle.Accept(visitor);

            visitorMock
                .Verify(v => v.VisitCircle(It.IsAny<Location>(), It.IsAny<decimal>()), Times.Once());
