...
namespace Sixeyed.SpecFlowItAll.AcceptanceTests
{
    ...
    public class ReorderProductSteps : StepBase
    {
        ...
        [Then(@"the supplier is sent an order request by Web service within (.*) milliseconds")]
        public void ThenTheSupplierIsSentAnOrderRequestByWebServiceWithinMilliseconds(int timeoutMilliseconds)
        {
            RetryAssert(() => ThenTheSupplierIsSentAnOrderRequestByWebService(), timeoutMilliseconds);
        }
