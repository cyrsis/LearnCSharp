...
namespace CustomerReport_ex.DataSetCustomerTableAdapters {
    ...
    public partial class CustomerInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[CustomerInfo] WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_CNAME = 1 AND [CNAME] IS NULL) OR ([CNAME] = @Original_CNAME)) AND ((@IsNull_ENAME = 1 AND [ENAME] IS NULL) OR ([ENAME] = @Original_ENAME)) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)) AND ((@IsNull_CustomerType = 1 AND [CustomerType] IS NULL) OR ([CustomerType] = @Original_CustomerType)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_MobilePhone = 1 AND [MobilePhone] IS NULL) OR ([MobilePhone] = @Original_MobilePhone)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
...
SELECT CustomerID, CNAME, ENAME, Photos, Birthday, CustomerType, Phone, MobilePhone, Fax, Address, Notes FROM CustomerInfo WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CustomerInfo] SET [CustomerID] = @CustomerID, [CNAME] = @CNAME, [ENAME] = @ENAME, [Photos] = @Photos, [Birthday] = @Birthday, [CustomerType] = @CustomerType, [Phone] = @Phone, [MobilePhone] = @MobilePhone, [Fax] = @Fax, [Address] = @Address, [Notes] = @Notes WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_CNAME = 1 AND [CNAME] IS NULL) OR ([CNAME] = @Original_CNAME)) AND ((@IsNull_ENAME = 1 AND [ENAME] IS NULL) OR ([ENAME] = @Original_ENAME)) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)) AND ((@IsNull_CustomerType = 1 AND [CustomerType] IS NULL) OR ([CustomerType] = @Original_CustomerType)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_MobilePhone = 1 AND [MobilePhone] IS NULL) OR ([MobilePhone] = @Original_MobilePhone)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT CustomerID, CNAME, ENAME, Photos, Birthday, CustomerType, Phone, MobilePhone, Fax, Address, Notes FROM CustomerInfo WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerReport_ex.Properties.Settings.Default.SISConnectionString;
        }
        ...
        public virtual int Fill(DataSetCustomer.CustomerInfoDataTable dataTable) {
        ...
        public virtual DataSetCustomer.CustomerInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(string Original_CustomerID, string Original_CNAME, string Original_ENAME, string Original_Birthday, string Original_CustomerType, string Original_Phone, string Original_MobilePhone, string Original_Fax, string Original_Address) {
            ...
            if ((Original_CustomerType == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_CustomerType));
            }
        ...
        public virtual int Update(
            ...
            if ((CustomerType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(CustomerType));
            }
            if ((Phone == null)) {
            ...
            if ((Original_CustomerType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_CustomerType));
            }
            if ((Original_Phone == null)) {
            ...
            if ((Original_MobilePhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_MobilePhone));
            }
            if ((Original_Fax == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Fax, 
                    string Original_Address) {
            return this.Update(Original_CustomerID, CNAME, ENAME, Photos, Birthday, CustomerType, Phone, MobilePhone, Fax, Address, Notes, Original_CustomerID, Original_CNAME, Original_ENAME, Original_Birthday, Original_CustomerType, Original_Phone, Original_MobilePhone, Original_Fax, Original_Address);
        }
    }
