...
Partial Public Class NorthwindDataContext
  ...
  End Sub
  Partial Private Sub InsertLinqCategory(instance As LinqCategory)
    End Sub
  Partial Private Sub UpdateLinqCategory(instance As LinqCategory)
    End Sub
  Partial Private Sub DeleteLinqCategory(instance As LinqCategory)
    End Sub
  Partial Private Sub InsertLinqProduct(instance As LinqProduct)
    End Sub
  Partial Private Sub UpdateLinqProduct(instance As LinqProduct)
    End Sub
  Partial Private Sub DeleteLinqProduct(instance As LinqProduct)
    End Sub
  #End Region
	
	Public Sub New()
		MyBase.New(Global.Data.My.MySettings.Default.NorthwindConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public ReadOnly Property LinqCategories() As System.Data.Linq.Table(Of LinqCategory)
		Get
			Return Me.GetTable(Of LinqCategory)
		End Get
	End Property
	
	Public ReadOnly Property LinqProducts() As System.Data.Linq.Table(Of LinqProduct)
		Get
			Return Me.GetTable(Of LinqProduct)
		End Get
	End Property
End Class

<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.Categories")>  _
Partial Public Class LinqCategory
	...
	Private _LinqProducts As EntitySet(Of LinqProduct)
	...
	Public Sub New()
		MyBase.New
		Me._LinqProducts = New EntitySet(Of LinqProduct)(AddressOf Me.attach_LinqProducts, AddressOf Me.detach_LinqProducts)
		OnCreated
	End Sub
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Category_Product", Storage:="_LinqProducts", ThisKey:="CategoryID", OtherKey:="CategoryID")>  _
	Public Property LinqProducts() As EntitySet(Of LinqProduct)
		Get
			Return Me._LinqProducts
		End Get
		Set
			Me._LinqProducts.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_LinqProducts(ByVal entity As LinqProduct)
		Me.SendPropertyChanging
		entity.LinqCategory = Me
	End Sub
	
	Private Sub detach_LinqProducts(ByVal entity As LinqProduct)
		Me.SendPropertyChanging
		entity.LinqCategory = Nothing
	End Sub
End Class

<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.Products")>  _
Partial Public Class LinqProduct
	Implements System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	...
	Private _LinqCategory As EntityRef(Of LinqCategory)
	...
	Public Sub New()
		MyBase.New
		Me._LinqCategory = CType(Nothing, EntityRef(Of LinqCategory))
		OnCreated
	End Sub
	...
	Public Property CategoryID() As System.Nullable(Of Integer)
		...
		Set
			If (Me._CategoryID.Equals(value) = false) Then
				If Me._LinqCategory.HasLoadedOrAssignedValue Then
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Category_Product", Storage:="_LinqCategory", ThisKey:="CategoryID", OtherKey:="CategoryID", IsForeignKey:=true)>  _
	Public Property LinqCategory() As LinqCategory
		Get
			Return Me._LinqCategory.Entity
		End Get
		Set
			Dim previousValue As LinqCategory = Me._LinqCategory.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._LinqCategory.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._LinqCategory.Entity = Nothing
					previousValue.LinqProducts.Remove(Me)
				End If
				Me._LinqCategory.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.LinqProducts.Add(Me)
					Me._CategoryID = value.CategoryID
				Else
					Me._CategoryID = CType(Nothing, Nullable(Of Integer))
				End If
				Me.SendPropertyChanged("LinqCategory")
			End If
		End Set
	End Property
