...
{
    public partial class AnalyseGoodsTrend : Form
    {
        public AnalyseGoodsTrend()
        {
            InitializeComponent();
        }
        ...
        {
            using (SqlConnection Con = new SqlConnection("server=(local);uid=sa;pwd=sa;database=db_TomeOne"))
            {
