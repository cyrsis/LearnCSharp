...
{
    public partial class ColumnByControl : Form
    {
        public ColumnByControl()
        {
            InitializeComponent();
        }
        ...
        {
            using (SqlConnection con = new SqlConnection("server=(local);uid=sa;pwd=sa;database=db_TomeOne"))	//實例化一個SqlConnection對像
            {
                int XValse = 20;
