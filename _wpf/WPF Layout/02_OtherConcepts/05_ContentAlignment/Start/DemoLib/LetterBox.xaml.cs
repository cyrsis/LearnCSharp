...
namespace DemoLib {
	...
	public partial class LetterBox : UserControl {
		...
		private void LetterBox_ToolTipOpening(object sender, ToolTipEventArgs e) {
			this.ToolTip = string.Format($"DesiredWidth: {this.DesiredSize.Width}, DesiredHeight: {this.DesiredSize.Height} [ActualWidth: {this.ActualWidth}, ActualHeightHeight: {this.ActualHeight}]");
		}
