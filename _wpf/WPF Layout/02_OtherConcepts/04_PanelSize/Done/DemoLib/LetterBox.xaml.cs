...
namespace DemoLib {
	...
	public partial class LetterBox : UserControl {
      ...
      this.ToolTip = string.Format($"DesiredWidth: {this.DesiredSize.Width}, DesiredHeight: {this.DesiredSize.Height} [ActualWidth: {this.ActualWidth}, ActualHeight: {this.ActualHeight}]");
