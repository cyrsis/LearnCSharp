Namespace WPFListBox
  Partial Public Class frmMain
    ...
    Protected Sub btnListBoxWithGrouping_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
      Dim frm As New frmListBoxWithGrouping1()
      frm.Show()
    End Sub

    Protected Sub btnListBoxWithGrouping2_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
      Dim frm As New frmListBoxWithGrouping2()
      frm.Show()
    End Sub
