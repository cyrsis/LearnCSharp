...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head runat="server">
		<title>Telerik Executive Dashboard</title>
		...
		<form id="form1" runat="server" style="height:100%">
			<div id="silverlightControlHost">
				<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
					...
					<%
					//write a <param> tag, having the build version as a GET query param (ex. ClientBin/ExecutiveDashboard.xap?v=20110506124356)
					const string xapPathIncludingFilename = "ClientBin/ExecutiveDashboard.xap";
					...
					<%--<param name="source" value="ClientBin/ExecutiveDashboard.xap"/>--%>
